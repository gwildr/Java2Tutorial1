...
public class DrawPolygonsOriginal extends Component{
    private ArrayList<String> polygonNames;
    private ArrayList<Point>  centerPoints;

    public DrawPolygonsOriginal(){
        polygonNames = new ArrayList<String>(10);
        centerPoints = new ArrayList<Point>(10);
    ...
    public static void main(String[] args) {
        ...
        DrawPolygonsOriginal polygons = new DrawPolygonsOriginal();
